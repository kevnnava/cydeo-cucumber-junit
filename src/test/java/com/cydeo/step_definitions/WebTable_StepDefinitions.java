...
public class WebTable_StepDefinitions {
    ...
    @Given("user is on the login page of web tables app")
    public void user_is_on_the_login_page_of_web_tables_app() {
    ...
    public void user_enters_below_credentials(Map<String, String>credentials) {
       ...
       // we can call out login utility method and pass values from map
